...
df = pd.read_csv(r"C:\Users\iyaro\OneDrive\Документы\-\Классификация_удовлитворенности_полетом(миникурс_ВШЭ)\df_features.csv")
...
image = Image.open(r"C:\Users\iyaro\OneDrive\Документы\-\Классификация_удовлитворенности_полетом(миникурс_ВШЭ)\8.jpg")
st.image(image)
st.write(
        """
